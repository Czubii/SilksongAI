...
{
    public class FrameSourcePlugin : IFramePipelinePlugin
    {
        ...
        public FrameSourcePlugin(IFixedUpdateDataSource<FrameData> frameSource, IReadOnlyCollection<IFrameSink> listeners)
        {
