...
from neural_networks.base_network import BaseBossNet
...
class BossModelArtifact:
    ...
    def save(self, path):
        torch.save({
            "format_version": Layout.SUPPORTED_LAYOUT_VERSION,
...
class BossModelFactory:
    ...
    def load(path: str, device: str = "cpu") -> BossModelArtifact:
        ...
        if checkpoint.get("format_version", 1) != Layout.SUPPORTED_LAYOUT_VERSION:
